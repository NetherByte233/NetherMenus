...
Install the [resource pack](https://github.com/NetherByte233/NetherMenus/releases/download/v1.0.0/InventoryUIResourcePack-main.mcpack) put the resource pack in the resource pack folder and set force_resources=true in resource_packs.yml and name file name of resource pack in resource_stack: like this 
```yaml
resource_stack:
